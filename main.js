...
function startProgram() {
    ...
    // document.getElementById("timer").style.textAlign = `end`;
    // document.getElementById("eee").style.textAlign = `end`;

    document.getElementById("startMe").addEventListener("click", timeStart);
}

function timeStart() {
    let launchTime = new Date(document.getElementById("dateLaunch").value);
    selectedColor = document.getElementById("selectColor").value;
